...
echo "Script Version 22.6 135 Check #3 Tier 4"
...
echo "13/03/2025.*AZDB_update_processing_backlog5" >> $override_file

echo "13/03/2025.*AZDB_update_processing_backlog47" >> $override_file
