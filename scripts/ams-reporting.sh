...
echo "Script Version 28.6: message_log 70M threshold"
...
elif [[ $schema_id == 38 ]] || [[ $schema_id == 135 ]] || [[ $schema_id == 105 ]] || [[ $schema_id == 125 ]];then
  backlog_adaptive_threshold=$(($backlog_adaptive_threshold*4))
elif [[ $schema_id == 129 ]] || [[ $schema_id == 82 ]] || [[ $schema_id == 124 ]] || [[ $schema_id == 31 ]];then
...
elif [[ $schema_id == 8 ]] || [[ $schema_id == 138 ]] || [[ $schema_id == 96 ]] || [[ $schema_id == 30 ]] || [[ $schema_id == 21 ]] || [[ $schema_id == 10 ]] || [[ $schema_id == 5 ]] || [[ $schema_id == 12 ]] || [[ $schema_id == 14 ]];then
...
echo "09/12/2025.*AZDB_fines_recon_status.*82" >> $override_file
