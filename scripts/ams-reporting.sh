...
echo "Script Version 21.3 rec x3 override"
...
echo "23/01/2025.*_recon_status" >> $override_file

echo "23/01/2025.*AZDB_update_processing_backlog(128|66)" >> $override_file
