...
echo "Script Version 28.0: TEST Check #3 126 Tier 4"
...
elif [[ $schema_id == 129 ]] || [[ $schema_id == 82 ]] || [[ $schema_id == 124 ]] || [[ $schema_id == 31 ]] || [[ $schema_id == 126 ]];then
  backlog_adaptive_threshold=$(($backlog_adaptive_threshold*3))
elif [[ $schema_id == 130 ]] || [[ $schema_id == 112 ]] || [[ $schema_id == 47 ]] || [[ $schema_id == 36 ]] || [[ $schema_id == 103 ]] || [[ $schema_id == 106 ]] || [[ $schema_id == 61 ]] || [[ $schema_id == 125 ]];then
