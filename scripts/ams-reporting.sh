...
echo "Script Version 28.0: Check #3 126 Tier 9"
...
if [[ $schema_id == 38 ]] || [[ $schema_id == 129 ]] || [[ $schema_id == 128 ]] || [[ $schema_id == 105 ]];then
  t_delta_threshold_mins=$((90*7))
elif [[ $schema_id == 77 ]] || [[ $schema_id == 11 ]] || [[ $schema_id == 99 ]] || [[ $schema_id == 126 ]] || [[ $schema_id == 125 ]];then
