...
echo "Script Version 26.9: 29 rec override"
...
echo "04/08/2025.*AZDB_fines_recon_status.*77" >> $override_file
echo "04/08/2025.*AZDB_update_processing_backlog77" >> $override_file
