...
echo "Script Version 26.7 Check #6 128 Tier5"
...
elif [[ $schema_id == 44 ]] || [[ $schema_id == 31 ]] || [[ $schema_id == 82 ]] || [[ $schema_id == 105 ]] || [[ $schema_id == 135 ]] || [[ $schema_id == 89 ]] || [[ $schema_id == 92 ]] || [[ $schema_id == 128 ]];then
