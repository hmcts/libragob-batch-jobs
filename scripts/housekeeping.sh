...
psql "sslmode=require host=${DB_HOST} dbname=${DB_NAME} user=${DB_USER} port=5432 password=${PGPASSWORD}" --***REMOVED***le=./sql/public_update_tables_housekeeping.sql
...
psql "sslmode=require host=${DB_HOST} dbname=${DB_NAME} user=${DB_USER} port=5432 password=${PGPASSWORD}" --***REMOVED***le=./sql/gateway_audit_messages_housekeeping.sql
...
psql "sslmode=require host=${DB_HOST} dbname=${DB_NAME} user=${DB_USER} port=5432 password=${PGPASSWORD}" --***REMOVED***le=./sql/dac_audit_messages_housekeeping.sql
